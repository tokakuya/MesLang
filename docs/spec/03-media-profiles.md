...
上のサンプル各コマから生成した **参考画像** を、サンプルテキストの直下に置く（原稿の一部ではない。二次ツール側の読み物）。

| コマ | 参考画像 |
|------|----------|
| `%1` 俯瞰ぎみ / 改札前の雑踏 | ![コマ1 参考画像](../../examples/manga/refs/profile-sample-1.jpg) |
| `%2` にか寄り・こいとの呆れ | ![コマ2 参考画像](../../examples/manga/refs/profile-sample-2.jpg) |

より長いページ例とコマごとの参考画像は [examples/manga/](../../examples/manga/) を参照。
